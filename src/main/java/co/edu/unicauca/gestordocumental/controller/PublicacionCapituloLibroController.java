...
public class PublicacionCapituloLibroController {
    ...
    public @ResponseBody void crearPublicacionRevista(
        ...
        String isbn = publicacionCapituloLibroValidador.validarIsbn(body.get("isbn"), true);
         ...
         */
        String rutaFolder = OpenKM.RUTA_BASE + estudiante.getUsuario().getUsuario() + "/CapituloLibro/" + tituloCapituloLibro;
    ...
    public ResponseEntity<InputStreamResource> getArchivoCapituloLibro(
        ...
        String rutaFolder = OpenKM.RUTA_BASE + publicacionCapituloLibro.getPublicacion().getEstudiante().getUsuario().getUsuario()
